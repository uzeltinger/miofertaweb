...
<div id="payment-details" class="event-booking-payment">
    <div class="event-booking-details row-fluid">
        <div class="event-ticket-details">
            ...
            <div class="event-guest-details ">
                <?php echo $this->orderDetails->serviceSummary?>
            </div>
        </div>
    </div>

    <form action="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&view=servicepayment&layout=redirect'.$menuItemId, false, $ssl); ?>" method="post" name="payment-form" id="payment-form" >
        <fieldset>
        ...
        <input type="hidden" name="task" value="servicepayment.processTransaction" />
