...
<div id="events">
	<div class="row-fluid" id="filterCategoryItems">
                                                    ...
                                                    foreach ($this->searchFilter["areas"] as $filterCriteria) {
                                                        if (empty($filterCriteria->areaName)) {
                                                            ...
                                                            <li <?php if ($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
                                                                <div <?php if ($selected) echo 'class="selected"'; ?>>
                                                                    <a href="javascript:void(0)"
                                                                       onclick="<?php echo $selected ? "removeFilterRule('area', '" . $filterCriteria->areaName . "')" : "addFilterRule('area', '" . $filterCriteria->areaName . "')"; ?>"><?php echo $filterCriteria->areaName; ?><?php echo ($selected) ? '<span class="cross">(remove)</span>' : ""; ?></a>
                                                                </div>
                                                            </li>
                                                            <?php
                                                        }
                                            ...
                                            foreach ($this->searchFilter["types"] as $filterCriteria) { ?>
                                                ...
                                                <?php if ($counterTypes < $this->appSettings->search_filter_items) { ?>
                                                    ...
                                                    <li <?php if ($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
                                                        <div <?php if ($selected) echo 'class="selected"'; ?>>
                                                            <a href="javascript:void(0)"
                                                               onclick="<?php echo ($selected) ? "removeFilterRule('type', " . $filterCriteria->typeId . ", ".$setCategory.", ".$categId." )" : "addFilterRule('type', " . $filterCriteria->typeId . ",".$setCategory.",".$categId.")"; ?>"><?php echo $filterCriteria->typeName; ?><?php echo ($selected) ? '<span class="cross">(remove)</span>' : ""; ?></a>
                                                        </div>
                                                    </li>
                                                    <?php $counterTypes++;
                                                } else { ?>
                                            ...
                                            <div style="display: none" id="extra_types_params">
                                                ...
                                                foreach ($this->searchFilter["types"] as $filterCriteria) {
                                                    if (empty($filterCriteria->typeName)) {
                                                        ...
                                                        $selected = isset($this->selectedParams["type"]) && in_array($filterCriteria->type, $this->selectedParams["type"]); ?>
                                                        <li <?php if ($searchType == 1 && $selected) echo 'class="selectedlink"'; ?>>
                                                            <div <?php if ($selected) echo 'class="selected"'; ?>>
                                                                <a href="javascript:void(0)"
                                                                   onclick="<?php echo ($selected) ? "removeFilterRule('type', " . $filterCriteria->typeId . ", ".$setCategory.", ".$categId." )" : "addFilterRule('type', " . $filterCriteria->typeId . ",".$setCategory.",".$categId.")"; ?>"><?php echo $filterCriteria->typeName; ?><?php echo ($selected) ? '<span class="cross">(remove)</span>' : ""; ?></a>
		...
		<div id="search-results" class="events-container search-results <?php echo $fullWidth ?'search-results-full span12':'search-results-normal span9' ?> ">
			<form action="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory'.$menuItemId) ?>" method="<?php echo $this->appSettings->submit_method ?>" name="adminForm" id="adminForm">
					...
					<div id="search-path">
    					<?php if(isset($this->category)) { ?>
        					<ul class="category-breadcrumbs">
        						<li>
        							<a class="search-filter-elem" href="<?php echo JRoute::_('index.php?option=com_jbusinessdirectory&view=events&resetSearch=1') ?>"><?php echo JText::_('LNG_ALL_CATEGORIES') ?></a>
        						</li>
        						<?php 
				...
				<div id="search-details" >
					...
					<div class="search-toggles">
						...
						<p class="view-mode">
							...
							<a id="list-view-link_1" class="list" title="List" href="javascript:showList_1(<?php echo $this->appSettings->events_search_results_list_view ?>)"><?php echo JText::_("LNG_LIST")?></a>
						</p>
						
						<?php if($this->appSettings->show_search_map && !empty($this->events)){?>
							<p class="view-mode">
				...
				<?php 
					require_once 'events_grid_view.php';
					require_once 'events_list_style_1.php';
				    require_once 'events_list_style_2.php';
				?>
